...
/**
 * The abstract analyzer task
 * 
 * @author Jared Hatfield (UnitVectorY Labs)
 */
@AllArgsConstructor(access = lombok.AccessLevel.PROTECTED)
public abstract class AbstractAnalyzerTask implements AbstractTask {
    ...
    public final DataProduct execute(DataContext dataContext) {
        ...
        AnalyzerDataContext analyzerDataContext = new AnalyzerDataContext();

        return this.executeAnalyzer(analyzerDataContext);
    }

    public abstract AnalyzerDataProduct executeAnalyzer(AnalyzerDataContext dataContext);
